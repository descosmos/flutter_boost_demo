...
import 'package:flutter_module/other_page.dart';
...
class BoostNavigatorObserver extends NavigatorObserver {
  ...
  void didPush(Route<dynamic> route, Route<dynamic>? previousRoute) {
    String nonNullableString = route.settings.name ?? "默认值";
    print('boost-didPush$nonNullableString');
  }

  @override
  void didPop(Route<dynamic> route, Route<dynamic>? previousRoute) {
    String nonNullableString = route.settings.name ?? "默认值";
    print('boost-didPop$nonNullableString');
  }

  @override
  void didRemove(Route<dynamic> route, Route<dynamic>? previousRoute) {
    String nonNullableString = route.settings.name ?? "默认值";
    print('boost-didRemove$nonNullableString');
  }

  @override
  void didStartUserGesture(Route<dynamic> route, Route<dynamic>? previousRoute) {
    String nonNullableString = route.settings.name ?? "默认值";
    print('boost-didStartUserGesture$nonNullableString');
  }
}
